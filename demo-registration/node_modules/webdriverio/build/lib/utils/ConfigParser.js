...
var HOOKS = ['before', 'beforeSuite', 'beforeHook', 'beforeTest', 'beforeCommand', 'afterCommand', 'afterTest', 'afterHook', 'afterSuite', 'after', 'beforeFeature', 'beforeScenario', 'beforeStep', 'afterFeature', 'afterScenario', 'afterStep', 'onError', 'onReload'];
    ...
    (0, _createClass3.default)(ConfigParser, [{
        ...
        value: function merge() {
            ...
            if (typeof object.spec === 'string') {
                var spec = _path2.default.resolve(process.cwd(), object.spec);
                if (!_fs2.default.existsSync(spec)) {
                    throw new Error('spec file ' + object.spec + ' not found');
                }

                this._config.specs = [spec];
            }
        ...
        value: function getSpecs(capSpecs, capExclude) {
            ...
            if (Array.isArray(suites) && suites.length > 0) {
                ...
                if (suiteSpecs.length === 0) {
                    throw new Error('The suite(s) "' + suites.join('", "') + '" you specified don\'t exist in your config file');
                }
        ...
        value: function getFilePaths(patterns, omitWarnings) {
            ...
            try {
                for (var _iterator5 = (0, _getIterator3.default)(patterns), _step5; !(_iteratorNormalCompletion5 = (_step5 = _iterator5.next()).done); _iteratorNormalCompletion5 = true) {
